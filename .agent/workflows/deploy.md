...
> [!CAUTION]
> **절대 `git checkout .`을 사용하지 마세요!** 로컬 변경사항이 전부 사라집니다.

```powershell
// turbo
gcloud compute ssh instance-20260223-054504 --project=gen-lang-client-0289807056 --zone=asia-northeast3-b --command="cd ~/dart-monitor && git pull && pm2 restart dart-monitor"
```
